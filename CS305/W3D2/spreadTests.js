...
// const concatArrayAndArg = myExports.concatArrayAndArg; 
...
describe("spread operator tests", function () {
    ...
    it("tests concatenate arrays and one number arg", function () {
        const arr = [1, 2, 3];
        const arg =7;
        assert.deepEqual(concatArrayAndArg(arr, arg), [1, 2, 3, 7]);
    });
