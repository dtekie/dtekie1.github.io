...
console.log("expect 49: ", const Square1.area()); 
console.log("expect 1: ", Object.getOwnPropertyNames 
const class Square = new Square2(10); 
console.log("expect 100: ", console.log("expect 1: ", classSquare.area ()); 
Object.getOwnPropertyNames (square1).length);
(constSquare1).length); ( classSquare ).length);
*/
