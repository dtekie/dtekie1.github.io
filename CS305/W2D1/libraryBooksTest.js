...
// const findAuthors = myExports.findAuthors; //do this for all of the functions used in the Mocha tests
// const findIDs = myExports.findIDs; //do this for all of the functions used in the Mocha tests
// const addBook = myExports.addBook; //do this for all of the functions used in the Mocha tests
