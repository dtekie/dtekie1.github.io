...
describe("map practice", function () {
  ...
  describe("filter practice", function () {
    ...
    //   assert.strictEqual(includesEvenNum([1,3,5,7,9]), false);
    // });
    ...
    describe("reduce practice", function () {
      ...
      it("average of even numbers ", function () {
        assert.equal(averageOfEvenNumbers(numArray), 70.5);
        const oddArray = [1, 3, 5, 7, 9];
        assert.equal(averageOfEvenNumbers(oddArray), 'NaN');
      });

      it("average of odd numbers ", function () {
        assert.deepEqual(averageOfOddNumbers(numArray), 35.00);
        const evenArray = [2, 4, 6];
        assert.deepEqual(averageOfOddNumbers(evenArray), 'NaN');
      });
      ...
      it("Even ages average ", function () {
        ...
        assert.deepEqual(averageOfEvenAges(peopleOddAge), 'NaN');
      });
      it("Odd ages average ", function () {
        ...
        assert.equal(averageOfOddAges(evenArray), 'NaN');
        
        assert.equal(averageOfOddAges(peopleArray), 14);
      });
      });
